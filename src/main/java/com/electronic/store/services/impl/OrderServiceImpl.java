...
public class OrderServiceImpl implements OrderService {
    ...
    public OrderDto createOrder(CreateOrderRequest orderDto) {
        ...
        //fetch cart
        Cart cart = cartRepository.findById(cartId).orElseThrow(() -> new ResourceNoteFoundException("Cart with given id not found on server !!"));
    ...
    public void removeOrder(String orderId) {
        Order order = orderRepository.findById(orderId).orElseThrow(() -> new ResourceNoteFoundException("Order not found !!"));
        orderRepository.delete(order);
    }

    @Override
    public List<OrderDto> getOrderOfUser(String userId) {
        User user = userRepository.findById(userId).orElseThrow(() -> new ResourceNoteFoundException("User not found by given id !!"));
